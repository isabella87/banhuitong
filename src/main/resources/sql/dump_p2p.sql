REM Generated at 2018-04-09 15:25:08
...
COMMENT ON COLUMN "PRJ_BONUS_DETAIL"."PAY_TYPE" IS '还款来源类型。1 - 正常  2- 保证金 3-名义借款人 99 - 其它';
...
CREATE TABLE "SHCA_SIGN_USER" (
	...
	"SIGN_LINK" VARCHAR2(800 CHAR) NOT NULL,
	"STATUS" NUMBER NOT NULL,
...
COMMENT ON COLUMN "SHCA_SIGN_USER"."SIGN_LINK" IS '签署链接';
...
COMMENT ON COLUMN "TS_CREDIT_ASSIGN"."ORDER_NO" IS '银行返回订单号。';
...
COMMENT ON COLUMN "TS_TENDER"."ORDER_NO" IS '订单号';
...
CREATE TABLE "SHCA_DOC_FILE" (
	"SDS_ID" NUMBER NULL,
	"FILE_ID" VARCHAR2(160 CHAR) NOT NULL,
	"FILE_NAME" VARCHAR2(800 CHAR) NOT NULL,
	"OBJECT_ID" NUMBER NOT NULL,
	"DOC_ID" NUMBER NULL,
	"DOWNLOAD_TIME" DATE NULL,
	"PAGE_COUNT" NUMBER NULL,
	"MULTI_SIGN" NUMBER DEFAULT 0 NOT NULL
);
...
COMMENT ON COLUMN "SHCA_DOC_FILE"."MULTI_SIGN" IS '是否需要多方
签署';
REM Primary key SHCA_DOC_FILE
ALTER TABLE "SHCA_DOC_FILE" ADD CONSTRAINT "SHCA_DOC_FILE_PK" PRIMARY KEY (FILE_ID) USING INDEX;
...
REM Index SHCA_DOC_FILE
CREATE INDEX "SHCA_DOC_FILE_UK2" ON "SHCA_DOC_FILE" (SDS_ID,FILE_NAME)
CREATE INDEX "SHCA_DOC_FILE_UK1" ON "SHCA_DOC_FILE" (OBJECT_ID,FILE_NAME)
CREATE INDEX "SHCA_DOC_FILE_PK1" ON "SHCA_DOC_FILE" (FILE_ID)
/
...
BEGIN
  ...
  DATEPOINT,
  PWD_SET,
  V_IDENTITY FROM ACC_JX_USER WHERE AU_ID = V_AU_ID;
