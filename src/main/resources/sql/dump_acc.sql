REM Generated at 2018-06-06 09:23:21
...
CREATE TABLE "TS_ACCOUNT_OPEN" (
	...
	"IDNO" VARCHAR2(100 CHAR) NOT NULL,
...
COMMENT ON COLUMN "TS_ACCOUNT_OPEN"."IDNO" IS '证件号码';
...
CREATE TABLE "TS_CHANGE_MOBILE" (
	...
	"AU_ID" NUMBER NOT NULL,
	"SMS_CODE" VARCHAR2(100 CHAR) NOT NULL,
	"LAST_SRV_AUTH_CODE" VARCHAR2(100 CHAR) NOT NULL,
	"STATUS" NUMBER DEFAULT 0 NULL,
	"DATEPOINT" TIMESTAMP(6) NULL,
	"NEW_MOBILE" VARCHAR2(20) NULL
);
...
COMMENT ON COLUMN "TS_CHANGE_MOBILE"."SMS_CODE" IS '验证码';
COMMENT ON COLUMN "TS_CHANGE_MOBILE"."LAST_SRV_AUTH_CODE" IS '前导业务授权码';
COMMENT ON COLUMN "TS_CHANGE_MOBILE"."STATUS" IS '状态：0-未成功  1-已成功';
COMMENT ON COLUMN "TS_CHANGE_MOBILE"."DATEPOINT" IS '交易完成时间';
COMMENT ON COLUMN "TS_CHANGE_MOBILE"."NEW_MOBILE" IS '新手机号';
