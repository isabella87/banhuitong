...
public class QueryUtil {
	...
	public Map<String, String> callProc(String proc, String[] inParams, String[] inParamsName, String[] outParams ) throws SQLException{
	...
	public Map<String, String> callFun(String proc, String[] inParams, String[] inParamsName, String[] outParams ) throws SQLException{
		Map<String, String> map = new HashMap<String, String>();
		Connection conn=this.getConnection();
		CallableStatement stmt=null;
		try {
	...
	public List<Map<String, String>> executeQuery(String sql,String[] params, int start, int length) throws SQLException{
		List<Map<String, String>> list=null;
		Connection conn=getConnection();
		PreparedStatement stmt = null;
		ResultSet rs = null;
