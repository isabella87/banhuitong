...
import com.bht.banhuitong.httpUtil.Constants;
import com.bht.banhuitong.httpUtil.MyHttpClient;
import com.bht.banhuitong.httpUtil.RequestService;
import com.bht.banhuitong.httpUtil.Urls;
...
public class RpcServiceImpl implements RpcService{
	...
	public List<Map<String, String>> getClientMgrTreeDatas(
		...
		return RpcDataServiceParser.getInstance().queryDataWithTowLevel(false,
				"GET", Urls.CLIENT_MGR_TREE_URL, paramMap);
	}

	public List<Map<String, String>> getCrmMgrRelation(
			Map<String, String> paramMap) {
		String url = Urls.ROOT_URL + "/p2psrv/mgr/crm/" + paramMap.get("name")
				+ "/infor";
		return RpcDataServiceParser.getInstance().queryDataWithTowLevel(false,
				"GET", url, paramMap);
	}
	...
	public List<Map<String, String>> getInvestors(Map<String, String> paramMap) {
		return RpcDataServiceParser.getInstance().queryDataWithTowLevel(false,
				"GET", Urls.QUERY_INVESTORS_URL, paramMap);
	}
	...
	public String queryProjects(Map<String, String> paramMap) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.LOAN_PROJS_URL, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	/**
	 * 通过ID 查询项目
	 * @param  paramMap[itemNoKey=, startTime=, endTime=, status=], p-id
	 * @return 符合条件记录 
	 */
	public String queryProjectById(Map<String, String> paramMap, long id) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.LOAN_PROJS_URL + "/" + id, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String previewLoanBonus(Map<String, String> paramMap, long id) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.LOAN_PROJS_URL + "/" + id + "/preview-bonus", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	/**
	 * 项目审批
	 * @param  paramMap[flag、comment、pId], id 项目id, action 审批操作
	 * @return 是否执行成功 
	 */
	public String approvalAction(Map<String, String> paramMap, long id, String action) {
		...
		try {
			jsonStr = RequestService.getInstance().postRequest(
					initParamsToList(paramMap), Urls.LOAN_PROJS_URL + "/" + id + "/" + action, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String createPrjGuaranteeOrg(Map<String, String> paramMap, long id) {
		...
		try {
			jsonStr = RequestService.getInstance().putRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + id + "/guarantee-org", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String createPrjGuaranteePerson(Map<String, String> paramMap, long id) {
		...
		try {
			jsonStr = RequestService.getInstance().putRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + id + "/guarantee-person", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String deletePrjGuaranteePerson(Map<String, String> paramMap, long pId, long pgpId) {
		...
		String jsonStr = null;
		try {
			jsonStr = RequestService.getInstance().delRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + pId + "/guarantee-person" + "/" + pgpId, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String deletePrjGuaranteeOrg(Map<String, String> paramMap, long pId, long pgoId) {
		...
		try {
			jsonStr = RequestService.getInstance().delRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + pId + "/guarantee-org" + "/" + pgoId, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String createPrjMgrOrg(Map<String, String> paramMap, long pId) {
		...
		try {
			jsonStr = RequestService.getInstance().putRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + pId + "/mgr-org", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String createPrjMgrPerson(Map<String, String> paramMap, long pId) {
		...
		try {
			jsonStr = RequestService.getInstance().putRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + pId + "/mgr-person", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String deletePrjMgrPerson(Map<String, String> paramMap, long pId, long id) {
		...
		try {
			jsonStr = RequestService.getInstance().delRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + pId + "/mgr-person" + "/" + id, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String deletePrjMgrOrg(Map<String, String> paramMap, long pId, long id) {
		...
		try {
			jsonStr = RequestService.getInstance().delRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + pId + "/mgr-org" + "/" + id, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryPrjRating(Map<String, String> paramMap, long pId) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + pId + "/rating", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	 ...
	 * </p>
	 * @param pId 供应贷ID。
	 * @param paramMap [pId、prjRating、sEngineering、sPrjMgr、sCtor、sOwner、sGuarantee、sAll]。
	 * @return 成功创建的项目评分记录数。
	 */
	...
	public String queryAuditLine(Map<String, String> paramMap, long pId) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + pId + "/actions", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String updateBondAmt(Map<String, String> paramMap, long pId) {
		...
		try {
			jsonStr = RequestService.getInstance().postRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + pId + "/bond", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryTenders(Map<String, String> paramMap, long pId) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + pId + "/tenders", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryUncheckedTenders(Map<String, String> paramMap, long pId) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + pId + "/unchecked-tenders", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String updateUncheckedTenders(Map<String, String> paramMap, long pId, long jbId) {
		...
		try {
			jsonStr = RequestService.getInstance().postRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + pId + "/update-unchecked-tender/" + jbId, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String completed(Map<String, String> paramMap, long pId) {
		...
		try {
			jsonStr = RequestService.getInstance().postRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + pId + "/completed", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryInvests(Map<String, String> paramMap, long pId) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + pId + "/invests", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryCancelTenders(Map<String, String> paramMap, long pId) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + pId + "/cancel-tenders", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryLoans(Map<String, String> paramMap, long pId) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + pId + "/loans", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	 ...
	 * 查询指定项目投资人信息
	 * @param  pId
	 * @return 从ts_invest 中查询某项目的并且s_type为1的投资，根据投资人au_id分组；（返回信息包括，姓名/机构名称、身份证号/统一社会信用代码、手机、电子邮箱、出借金额）
	 */
	public String queryInvestors(Map<String, String> paramMap, long pId) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + pId + "/investors", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String isBanCredit(Map<String, String> paramMap, long pId) {
		...
		try {
			jsonStr = RequestService.getInstance().postRequest(
					initParamsToList(paramMap), Urls.MGR_PRJ_URL + "/" + pId + "/credit-out-status", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String cancelAutoCredit(Map<String, String> paramMap, long pId) {
		...
		try {
			jsonStr = RequestService.getInstance().delRequest(
					initParamsToList(paramMap), Urls.AUTO_CREDIT_URL + "/" + pId, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String withdrawTender(Map<String, String> paramMap, long ttId) {
		...
		try {
			jsonStr = RequestService.getInstance().putRequest(
					initParamsToList(paramMap), Urls.MGR_TRANS_URL + "/tenders/" + ttId + "/cancellation", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String cancelTender(Map<String, String> paramMap, long tctId) {
		...
		try {
			jsonStr = RequestService.getInstance().postRequest(
					initParamsToList(paramMap), Urls.MGR_TRANS_URL + "/cancel-tender/" + tctId + "/execution", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String traceCredit(Map<String, String> paramMap, long tiId) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.TRANS_URL + "/" + tiId + "/credit-trace", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryAccountBorrow(Map<String, String> paramMap) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.ACCOUNT_BORROW_URL + "/jx-completed", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryAccountBorrowByPId(Map<String, String> paramMap, long pId) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.LOAN_PROJS_URL + "/" + pId + "/financier", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String updateNominalAndBondsman(Map<String, String> paramMap, long pId) {
		...
		try {
			jsonStr = RequestService.getInstance().postRequest(
					initParamsToList(paramMap), Urls.LOAN_PROJS_URL + "/" + pId + "/related-financier", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryOwners(Map<String, String> paramMap) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.OWNER_URL, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryOwnerById(Map<String, String> paramMap, long id) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.OWNER_URL + "/" + id, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryCtorOrg(Map<String, String> paramMap) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.CTOR_ORG_URL, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryCtorOrgById(Map<String, String> paramMap, long id) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.CTOR_ORG_URL + "/" +id, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryEngineer(Map<String, String> paramMap) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.ENGINEER_URL, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryEngineerById(Map<String, String> paramMap, long id) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.ENGINEER_URL + "/" + id, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryGuaranteeOrg(Map<String, String> paramMap) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.GUARANTEE_ORG_URL, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryGuaranteeOrgById(Map<String, String> paramMap, long id) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.GUARANTEE_ORG_URL + "/" + id, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryGuaranteePerson(Map<String, String> paramMap) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.GUARANTEE_PERSON_URL, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryGuaranteePersonById(Map<String, String> paramMap, long id) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.GUARANTEE_PERSON_URL + "/" + id, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryMgrOrgs(Map<String, String> paramMap) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.MGR_ORG_URL, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryMgrOrgById(Map<String, String> paramMap, long id) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.MGR_ORG_URL + "/" + id, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryMgrPerson(Map<String, String> paramMap) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.MGR_PERSON_URL, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String queryMgrPersonById(Map<String, String> paramMap, long id) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.MGR_PERSON_URL + "/" + id, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String upload(Map<String, String> paramMap, byte[] content) {
		...
		String jsonStr = null;
		String contentStr = Base64.encodeBase64String(content);
		
		paramMap.put("content", contentStr);
		
		try {
			jsonStr = RequestService.getInstance().postRequest(initParamsToList(paramMap),
					Urls.FILE_UPLOAD_URL + "/content2", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public String getFiles(Map<String, String> paramMap) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.QUERY_FILES_URL, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String putFiles(Map<String, String> paramMap) {
		...
		try {
			jsonStr = RequestService.getInstance().putRequest(
					initParamsToList(paramMap), Urls.UPLOAD_OR_DOWNLOAD_URL, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String postFiles(Map<String, String> paramMap, long fileId) {
		...
		try {
			jsonStr = RequestService.getInstance().postRequest(
					initParamsToList(paramMap), Urls.UPLOAD_OR_DOWNLOAD_URL + "/" + fileId + "/content", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String deleteFile(Map<String, String> paramMap, long fileId) {
		...
		try {
			jsonStr = RequestService.getInstance().delRequest(
					initParamsToList(paramMap), Urls.UPLOAD_OR_DOWNLOAD_URL + "/" + fileId, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String login(Map<String, String> paramMap) {
		...
		header.put(
				"Cookie",
				MyHttpClient.__COOKIE_VALUE__ == null ? Constants.__TEMP__COOKIE_VALUE__
						: MyHttpClient.__COOKIE_VALUE__);
...
//			jsonStr = RpcDataServiceParser.getInstance().queryData(true, "POST", Urls.LOGIN_URL, paramMap);
			jsonStr =RequestService.getInstance().postRequest(initParamsToList(paramMap), Urls.LOGIN_URL, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String validateUser(Map<String, String> paramMap) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.VALIDATE_USER_URL, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String getUsers(Map<String, String> paramMap) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.QUERY_USERS_URL, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String getUserByUserName(Map<String, String> paramMap, String userName) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.QUERY_USERS_URL + "/" + userName, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String resetUserPassword(Map<String, String> paramMap, String userName) {
		...
		try {
			jsonStr = RequestService.getInstance().postRequest(
					initParamsToList(paramMap), Urls.QUERY_USERS_URL + "/" + userName + "/reset-pwd", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String getRolesByUserName(Map<String, String> paramMap, String userName) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.QUERY_USERS_URL + "/" + userName + "/roles", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String getRoles(Map<String, String> paramMap) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.QUERY_ROLES_URL, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String getRoleByRoleName(Map<String, String> paramMap, String roleName) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.QUERY_ROLES_URL + "/" + roleName, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	/**
	 * ROLES
	 * @param  paramMap: roleName、title、description、 enabled
	 * @return jsonStr
	 */
	...
	public String getPermsByRoleName(Map<String, String> paramMap, String roleName) {
		...
		try {
			jsonStr = RequestService.getInstance().getRequest(
					initParamsToList(paramMap), Urls.QUERY_ROLES_URL + "/" + roleName + "/perms", header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	public String changePassword(Map<String, String> paramMap) {
		...
		try {
			jsonStr = RequestService.getInstance().postRequest(
					initParamsToList(paramMap), Urls.UPDATE_PASSWORD_URL, header);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return jsonStr;
	...
	private BasicNameValuePair[] initParamsToArray(Map<String, String> paramMap) {
	...
	public static void main(String[] args) throws UnsupportedEncodingException,
		...
		List<Map<String, String>> list = new RpcServiceImpl()
				.getClientMgrTreeDatas(paramMap);
